...
class History:
    def __init__(self, prevLable1, prevLable2, sentence, position):
        # prevLetter, nextLetter, prevWord, currWord
        self.prevLabel1 = prevLable1
        self.prevLabel2 = prevLable2
        self.sentence = sentence
        self.position = position
        self.current_word, self.prev_word, self.position_in_word = self.__parse_words(sentence, position)
    ...
    def __parse_words(self, sentence, position):
        ...
        return current_word, prev_word, position_in_word
...
sentence = [2, 11, 12, 3, 2, 1, 10, 21, 2, 112, 412]
histTest = History('a', 'u', sentence, 2)
